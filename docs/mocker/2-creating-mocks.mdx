...
Unitary's mocking engine is designed to make mocking in PHP simpler, more expressive, and better integrated into your test flow. Unitary removes unnecessary boilerplate and lets you focus on the behavior you want to verify.
...
| `wrap()`                      | Decorates the method while executing on the real class instance          |
